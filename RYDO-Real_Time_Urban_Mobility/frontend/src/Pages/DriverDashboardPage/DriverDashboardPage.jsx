...
function DriverDashboardPage() {
  ...
  const driver = {
    fullName:      raw.fullName      || 'Driver',
    vehicleType:   raw.vehicleType   || raw.vehicle_type   || 'Not set',
    vehicleNumber: raw.vehicleNumber || raw.vehicle_number || 'Not set',
  };
  ...
  return (
    <div className="driver-page">
      ...
      {chatOpen && currentRide && (
        <RideChat
          rideId={String(currentRide.booking_id)}
